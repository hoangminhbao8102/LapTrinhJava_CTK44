...
public class Bank {
    ...
    public void addAccount(String customerID, Account account) {
        ...
        if (customer == null) {
            ...
            throw new IllegalArgumentException("Không tìm thấy khách hàng với CCCD: " + customerID);
        }
        ...
        try {
            ...
            throw new IllegalArgumentException("Tài khoản đã tồn tại hoặc không hợp lệ: " + account.getAccountNumber());
        }
    }
